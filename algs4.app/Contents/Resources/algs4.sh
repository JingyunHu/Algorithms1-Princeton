...
if [ "$JAVAC_VERSION" = "7" ] || [ "$JAVAC_VERSION" = "8" ] || [ "$JAVAC_VERSION" == "9" ]; then
    print
    print "Java ${JAVAC_VERSION} appears to be properly installed."
else
    print
    red 'Neither the Java 7 nor Java 8 JDK was detected.'
    red 'Install the Java 8 JDK; then retry this installer.'
    print
